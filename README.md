...
[![CI](https://github.com/intergonzalo/agentic-operations-gateway/actions/workflows/ci.yml/badge.svg)](https://github.com/intergonzalo/agentic-operations-gateway/actions/workflows/ci.yml)
...
This repository is deliberately independent from the private production systems that inspired the patterns. It uses synthetic names, synthetic data and Node.js built-ins only.
